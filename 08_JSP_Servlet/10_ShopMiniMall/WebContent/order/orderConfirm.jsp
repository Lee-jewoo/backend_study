...
<form name="myForm" action="" method="get">
	<input type="hidden" name="gCode" value="${cartDTO.gCode}">
	<input type="hidden" name="gName" value="${cartDTO.gName}">
	<input type="hidden" name="gPrice" value="${cartDTO.gPrice}">
	<input type="hidden" name="gSize" value="${cartDTO.gSize}">
	<input type="hidden" name="gColor" value="${cartDTO.gColor}">
	<input type="hidden" name="gAmount" value="${cartDTO.gAmount}">
	<input type="hidden" name="gImage" value="${cartDTO.gImage}">
	<input type="hidden" name="cartNum" value="${cartDTO.num}">
	<table width="80%" cellspacing="0" cellpadding="0">
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<img src="images/items/${cartDTO.gImage}.gif" border="0" align="center" width="80" /></td>
						<td class="td_default" width="300" style='padding-left: 30px'>${cartDTO.gName}<br> 
						<font size="2" color="#665b5f">[옵션 : 사이즈(${cartDTO.gSize}) ,
								색상(${cartDTO.gColor})] </font>
						</td>
						<td class="td_default" align="center" width="110">${cartDTO.gPrice}</td>
						<td class="td_default" align="center" width="90">${cartDTO.gAmount}</td>
					</tr>
					<tr>
						<td height="30"></td>
						<td class="td_default" align="right">총 결제 금액 :</td>
						<td class="td_default" align='right'>${cartDTO.gPrice*cartDTO.gAmount}</td>
					</tr>
				</table>
		<tr>
			<td>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<input class="input_default" type="text" id="mname" size="20"
							maxlength="20" value="${memberDTO.username}"></input>
						</td>
					</tr>
					<tr>
						<td height="35" class="td_default">우편번호</td>
						<td height="35" class="td_default">
						<input class="input_default" type="text" id="mpost" value="${memberDTO.post}" readonly></input>
						</td>
					</tr>
					<tr>
						...
						<input class="input_default" type="text" id="maddress1" size="35"
							maxlength="200" value="${memberDTO.addr1}" readonly></input><br> 
						<input class="input_default" type="text" id="maddress2" size="35"
							maxlength="200" value="${memberDTO.addr2}" readonly></input>
						</td>
					</tr>
					<tr>
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						<td width="125" height="35" class="td_default">이 름</td>
						<td height="35" class="td_default">
						<input class="input_default" type="text" id="orderName" name="orderName"
							size="20" maxlength="20" value=""></input>
						</td>
					</tr>
					<tr>
						<td height="35" class="td_default">우편번호</td>
					...
					<tr>
						<td height="35" class="td_default">휴대전화</td>
						<td height="35" class="td_default">
						<input class="input_default" type="text" id="phone" name="phone"
		...
		<tr>
			...
			<input type="button" id="orderDoneBtn" value="결제하기">
		</td>
		</tr>
	</table>
