...
public class MemberAgeMain {
	...
	public static void main(String[] args) {
		...
		int sum = members.stream().collect(Collectors.summingInt(Member::getAge));
		double avg = members.stream().collect(Collectors.averagingDouble(Member::getAge));
		Member max = members.stream().collect(Collectors.maxBy(Comparator.comparing(Member::getAge))).orElse(null);
		Member min = members.stream().collect(Collectors.minBy(Comparator.comparing(Member::getAge))).orElse(null);
