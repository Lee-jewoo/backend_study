			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<img src="images/items/<%= cartDTO.getgImage() %>.gif" border="0" align="center" width="80" /></td>
						<td class="td_default" width="300" style='padding-left: 30px'><%= cartDTO.getgName() %><br> 
						<font size="2" color="#665b5f">[옵션 : 사이즈(<%= cartDTO.getgSize() %>) ,
								색상(<%= cartDTO.getgColor() %>)] </font>
						</td>
						<td class="td_default" align="center" width="110"><%= cartDTO.getgPrice() %></td>
						<td class="td_default" align="center" width="90"><%= cartDTO.getgAmount() %></td>
					</tr>
					<tr>
						<td height="30"></td>
						<td class="td_default" align="right">총 결제 금액 :</td>
						<td class="td_default" align='right'><%= cartDTO.getgPrice()*cartDTO.getgAmount()%></td>
					</tr>
				</table>
		<tr>
			<td>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<input class="input_default" type="text" id="mname" size="20"
							maxlength="20" value="<%= memberDTO.getUsername() %>"></input>
						</td>
					</tr>
					<tr>
						<td height="35" class="td_default">우편번호</td>
						<td height="35" class="td_default">
						<input class="input_default" type="text" id="mpost" value="<%= memberDTO.getPost() %>" readonly></input>
						</td>
					</tr>
					<tr>
						...
						<input class="input_default" type="text" id="maddress1" size="35"
							maxlength="200" value="<%= memberDTO.getAddr1() %>" readonly></input><br> 
						<input class="input_default" type="text" id="maddress2" size="35"
							maxlength="200" value="<%= memberDTO.getAddr2() %>" readonly></input>
						</td>
					</tr>
					<tr>
						...
						<input class="input_default" type="text" id="mphone" size="15"
							maxlength="15" value="<%= memberDTO.getPhone1() %>-<%= memberDTO.getPhone2() %>-<%= memberDTO.getPhone3() %>"></input>
						</td>
					</tr>
				</table>
			</td>
